...
public class HUDTimeout : MonoBehaviour, IProgressIndicator
{
	//****************************************************************************************************
	//
	//****************************************************************************************************
	...
	static private HUDTimeout m_instance = null;

	static public  HUDTimeout Instance { get { return m_instance; } }
	...
	private void Update()
	{
		...
		if( ( Time.time - m_touchTime ) > MAX_INACTIVITY_DURATION )
		{
			m_fade.Begin( FADE_TYPE.FADE_OUT, FADE_OUT_DURATION );
		}
